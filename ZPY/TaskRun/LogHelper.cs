...
namespace CPiao.TaskRun
{
    public class LogHelper
    {
        ...
        {
            LogClass.Log.WriteLogs(client, "", client, message.ToString(), root + "\\" + name + "\\", false);
      
        }
        public static void Debug(string client, string name, object message)
        { 
            LogClass.Log.WriteLogs(client, "", client, message.ToString(), root + "\\Debug" + name + "\\", false);
        }
        public static void Error(string client, string name, object message)
        {
            LogClass.Log.WriteLogs(client, "", client, message.ToString(), root + "\\Error" + name + "\\", false);
        }
    }
}